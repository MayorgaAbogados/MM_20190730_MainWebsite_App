...
<!-- -- HTML AND STYLES --------------------------------------------------- -->
<!-- ---------------------------------------------------------------------- -->
  <template src='./free-consulting-form-section.component.html'></template>
  <style src="./free-consulting-form-section.component.less" lang="less"></style>
<!-- ---------------------------------------------------------------------- -->
...
import { postFreeConsulting } from '../../helpers/freeConsulting.api';
