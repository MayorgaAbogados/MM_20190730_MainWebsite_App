...
import { DropdownItem, DropdownMenu } from "./models/dropdown.interfaces";
...
export default class DefaultDropdown extends Vue {
  ...
  private getHeaderSizeClass(): string {
    ...
    const titleLarge: string =
      titleSize >= 12 && titleSize < 14 ? "mm-dq-size-large" : "";
    const titleMiddle: string =
      titleSize >= 8 && titleSize < 12 ? "mm-dq-size-middle" : "";
...
.mm-subtitle {
  ...
  padding: 5px;
  margin: 0px;
  font-family: @h1-subtitle-font-family;
  font-size: @h1-subtitle-font-size;
  font-weight: @h1-subtitle-font-weight;
  letter-spacing: @h1-subtitle-letter-spacing;
  color: @h1-subtitle-color-gray;
}
div.mm-dropdown {
  display: block;
  max-width: 200px;
...
div.mm-dq-size-exlarge {
  width: 12em;
}
div.mm-dq-size-large {
  width: 10em;
}
div.mm-dq-size-middle {
  width: 8em;
}
div.mm-dq-size-small {
  width: 5em;
}
div.mm-dq-is-active {
